...
const Projects = () => {
  ...
  return (
    <section id="Projects" className="max-w-7xl mx-auto px-6 py-24 bg-gray-50">
...
{selectedProject && (
  ...
  >
    ...
    >
      ...
      {/* Right column: could be image or screenshot placeholder */}
      <div className="md:w-1/2 w-full flex items-center justify-center">
        {/* Optional: add project screenshot or illustration here */}
      </div>
    </div>
  </div>
)}
